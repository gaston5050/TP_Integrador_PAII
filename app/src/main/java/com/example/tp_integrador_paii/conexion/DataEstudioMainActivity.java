...
public class DataEstudioMainActivity {
    private Object object;
    private static Context context;

    public DataEstudioMainActivity(Object object, Context context) {
        this.object = object;
        this.context = context;
    }

    public interface EstudioCallback {
        void onResponse(Object response);

        void onError(String mensaje);
    }

    public static void obtenerTodos(DataEstudioMainActivity.EstudioCallback callback) {
        ExecutorService executor = Executors.newSingleThreadExecutor();
        executor.execute(() -> {
            List<Estudio> listaRegistros = new ArrayList<>();
            try {
                // Crear sentencia SQL para obtener todas las registros de la tabla
                String sql = "SELECT * FROM " + DataDB.TABLE_ESTUDIO;
                ...
                while (resultSet.next()) {
                    ...
                    estudio.setId(resultSet.getInt(DataDB.COLUMN_ESTUDIO_ID));
                    estudio.setDescripcion(resultSet.getString(DataDB.COLUMN_ESTUDIO_DESCRIPCION));
                    listaRegistros.add(estudio);
                }
